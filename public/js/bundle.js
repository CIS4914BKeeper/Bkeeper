...
},{}],"signupRequest.js":[function(require,module,exports) {
"use strict";
...
var signupRequest = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Request sent successfully. Please check your email');
  ...
  return function signupRequest(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.signupRequest = signupRequest;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"setPassword.js":[function(require,module,exports) {
"use strict";
...
var setPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(passwords) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:3000/api/v1/users/setPassword/".concat(token),
            data: passwords
          });
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Password setup successfully!');
            window.setTimeout(function () {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', 'Please check your password and try again!');
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function setPassword(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.setPassword = setPassword;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"login.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"metrics.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.metricIntake = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var metricIntake = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(metrics) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
  ...
  return function metricIntake(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.metricIntake = metricIntake;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"graph.js":[function(require,module,exports) {
...
var _setPassword = require("./setPassword");
...
var signupRequestForm = document.querySelector('#requestForm');
var logOutBtn = document.querySelector('.logout');
var metricIntakeForm = document.querySelector('#studentInfoForm');
var graphform = document.querySelector('#myChart');
if (metricIntakeForm) {
...
if (signupRequestForm) {
  signupRequestForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (passwordForm) passwordForm.addEventListener('submit', function (e) {
  ...
  (0, _setPassword.setPassword)(passwords);
});
...
if (graphform) {
  document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var res, graphData, classes, numStudents, data, ctx, myChart, buttons;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch('/get-metric-data', {
            method: 'GET'
          });
        case 2:
          res = _context.sent;
        ...
        case 5:
          ...
          classes = Object.keys(graphData.data);
          numStudents = Object.values(graphData.data);
          data = {
            labels: classes,
            datasets: [{
          ...
          ctx = document.getElementById("myChart").getContext("2d"); // Create the bar chart
          ...
          buttons = document.querySelectorAll('.btn[data-class]');
          buttons.forEach(function (button) {
            button.addEventListener('mouseover', function () {
              var className = button.getAttribute('data-class');
              button.innerText = "Period ".concat(button.getAttribute('data-period'), ": ").concat(className);
            });
            button.addEventListener('mouseout', function () {
              button.innerText = "Period ".concat(button.getAttribute('data-period'));
            });
          });
        case 13:
        case "end":
